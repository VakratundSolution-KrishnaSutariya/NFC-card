                                        ...
                                        <tr class="cart-item">
                                          <td class="cart-item-media">
                                            <div class="mini-img-wrapper">
                                                <img class="mini-img" src="{{asset('assets/images/1.jpg')}}" alt="img">
                                            </div>                                    
                                          </td>
                                          ...
                                          <td class="cart-item-quantity">
                                            <div class="quantity d-flex align-items-center justify-content-between">
                                                <button class="qty-btn dec-qty"><img src="{{asset('assets/images/plus.svg')}}"
                                                        alt="minus"></button>
                                                <input class="qty-input" type="number" name="qty" value="1" min="0">
                                                <button class="qty-btn inc-qty"><img src="{{asset('assets/images/plus.svg')}}"
                                                        alt="plus"></button>
                                            </div>
