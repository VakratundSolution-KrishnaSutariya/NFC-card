                            ...
                            <div class="product-card">
                                <div class="product-card-img">
                                    ...
                                    <div class="product-card-action product-card-action-2 justify-content-center">
                                        <a href="{{ url('shop/'.$subscriptionProduct->id) }}" class="action-card action-quickview">
                                ...
                                <div class="product-card-details">
                                    ...
                                    <h3 class="product-card-title">
                                        <a href="{{ url('shop/'.$subscriptionProduct->id) }}">{{ $subscriptionProduct->product_title }}</a>
                                    </h3>
                                    <div class="product-card-price">
                                        <span class="card-price-regular">${{ $subscriptionProduct->product_price }}</span>
                                        
                                        <span class="card-price-compare text-decoration-line-through">${{ $subscriptionProduct->product_price_fix_discount }}</span>
