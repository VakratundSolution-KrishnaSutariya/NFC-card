                    ...
                    <?php $__currentLoopData = $customFilters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div wire:key="filter-<?php echo e($key); ?>" class="p-2">
                            ...
                            <?php if($filter->isSelect()): ?>
                                <?php echo $__env->make('livewire-tables::bootstrap-5.includes.filter-type-select', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php elseif($filter->isMultiSelect()): ?>
                                <?php echo $__env->make('livewire-tables::bootstrap-5.includes.filter-type-multiselect', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php elseif($filter->isDate()): ?>
                                <?php echo $__env->make('livewire-tables::bootstrap-5.includes.filter-type-date', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php elseif($filter->isDatetime()): ?>
                                <?php echo $__env->make('livewire-tables::bootstrap-5.includes.filter-type-datetime', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php endif; ?>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Nfc-vcard\resources\views/vendor/livewire-tables/bootstrap-5/includes/filters.blade.php ENDPATH**/ ?>