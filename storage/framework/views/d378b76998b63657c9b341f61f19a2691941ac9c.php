<?php if($this->showBulkActionsDropdown): ?>
    <div class="mb-3 mb-md-0" id="<?php echo e($bulkKey = \Illuminate\Support\Str::random()); ?>-bulkActionsWrapper">
        <div class="dropdown d-block d-md-inline">
            <button class="btn dropdown-toggle d-block w-100 d-md-inline" type="button" id="<?php echo e($bulkKey); ?>-bulkActions"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <?php echo app('translator')->get('Bulk Actions'); ?>
            </button>

            <div class="dropdown-menu dropdown-menu-end w-100" aria-labelledby="<?php echo e($bulkKey); ?>-bulkActions">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Nfc-vcard\resources\views/vendor/livewire-tables/bootstrap-5/includes/bulk-actions.blade.php ENDPATH**/ ?>