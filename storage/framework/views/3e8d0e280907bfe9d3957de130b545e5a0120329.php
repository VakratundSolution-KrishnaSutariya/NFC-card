<?php if(getSuperAdminSettingValue('is_cookie_banner') == true && request()->path()=='/'||request()->path()=='terms-conditions'||request()->path()=='privacy-policy'): ?>
    <?php if($cookieConsentConfig['enabled'] && ! $alreadyConsentedWithCookies && !Session::get('declined')): ?>
...
<?php /**PATH C:\xampp\htdocs\Nfc-vcard\resources\views/vendor/cookie-consent/index.blade.php ENDPATH**/ ?>