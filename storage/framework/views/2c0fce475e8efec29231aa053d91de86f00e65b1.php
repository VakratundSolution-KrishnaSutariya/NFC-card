                            ...
                            <div class="announcement-meta d-flex align-items-center">
                                ...
                                <div class="currency-wrapper">
                                    <button type="button" class="currency-btn btn-reset text-white"
                                        ...
                                        <img class="flag" src="<?php echo e(asset('assets/images/cad.jpg')); ?>" alt="img">
                                        <span>USD</span>
                                        <span>
                        ...
                        <div class="col-lg-3 col-md-4 col-4">
                            <div class="header-logo">
                                <a href="index.html" class="logo-main">
                                    <img src="<?php echo e(getLogoUrl()); ?>" loading="lazy" alt="bisum">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="minicart-loop custom-scrollbar">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="<?php echo e(asset('assets/images/cad.jpg')); ?>" alt="img">
                            </div>
                            <div class="product-info">
                                ...
                                <div class="misc d-flex align-items-end justify-content-between">
                                    <div class="quantity d-flex align-items-center justify-content-between">
                                        <button class="qty-btn dec-qty"><img src="<?php echo e(asset('assets/images/cad.jpg')); ?>"
                                                alt="minus"></button>
                                        <input class="qty-input" type="number" name="qty" value="1" min="0">
                                        <button class="qty-btn inc-qty"><img src="<?php echo e(asset('assets/images/cad.jpg')); ?>"
                                                alt="plus"></button>
                                    </div>
...
<?php /**PATH C:\xampp\htdocs\Nfc-vcard\resources\views/front/layouts/header.blade.php ENDPATH**/ ?>