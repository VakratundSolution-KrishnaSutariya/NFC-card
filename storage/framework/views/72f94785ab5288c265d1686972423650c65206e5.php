<div class="aside-menu-container" id="sidebar">
    <div class="aside-menu-container__aside-logo flex-column-auto">
        <a data-turbo="false" href="<?php echo e(url('/#home')); ?>" class="text-decoration-none sidebar-logo">
            <img src="<?php echo e(getLogoUrl()); ?>" alt="Logo" class="object-fit-cover sidebar-app-logo"/>
        </a>
    ...
    <form class="d-flex position-relative aside-menu-container__aside-search search-control py-3 mt-1">
        <div class="position-relative w-100">
            <input class="form-control" type="text" placeholder="<?php echo e(__('auth.app.search')); ?>" aria-label="Search" id="menuSearch">
...
<?php /**PATH C:\xampp\htdocs\Nfc-vcard\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>